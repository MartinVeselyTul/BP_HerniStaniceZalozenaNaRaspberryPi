...
col = 10  # 10 columns
row = 20  # 20 rows
s_width = 1024  # window width
s_height = 600  # window height
play_width = 200  # play window width; 300/10 = 30 width per block
play_height = 400  # play window height; 600/20 = 20 height per block
...
def main():
    ...
    pygame.quit()
    pygame.display.quit()
    print("skore v metode main je: ", score)
    return score
