...
def player_animation():
	global player_speed, player_score, player
...
def opponent_animation():
	global opponent_speed, opponent_score, opponent
...
def main():
	global ball_speed_x, ball_speed_y, player_score, opponent_score, score_time, screen_height, screen_width, score_sound, opponent, opponent_speed, player_speed, player, ball, ball_color, line_color, bg_color, screen, clock, game_font, player_color, opponent_color, white, pong_sound
	# normal game set up
	...
	while True:
		...
		screen.blit(player_text, (535, 300))

		opponent_text = game_font.render(f"{opponent_score}", False, white)
		screen.blit(opponent_text, (475, 300))
